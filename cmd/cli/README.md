...
The CLI command APIs can be used directly from a Go application, see [Skycoin CLI Godoc](https://godoc.org/github.com/samoslab/haicoin/src/cli).
...
```bash
$ cd $GOPATH/src/github.com/samoslab/haicoin/cmd/cli
$ ./install.sh
```
...
```bash
$ PROG=skycoin-cli source $GOPATH/src/github.com/samoslab/haicoin/cmd/cli/autocomplete/bash_autocomplete
```
