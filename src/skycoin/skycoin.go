...
import (
	...
	"github.com/samoslab/haicoin/src/api"
	"github.com/samoslab/haicoin/src/cipher"
	"github.com/samoslab/haicoin/src/coin"
	"github.com/samoslab/haicoin/src/daemon"
	"github.com/samoslab/haicoin/src/util/apputil"
	"github.com/samoslab/haicoin/src/util/browser"
	"github.com/samoslab/haicoin/src/util/cert"
	...
	"github.com/samoslab/haicoin/src/wallet"
)
...
func InitTransaction() coin.Transaction {
	...
	output := cipher.MustSHA256FromHex("382c9e00d4a41637d789961d7cdcd35ea6a08fcc9443a9dc0e5add9951842754")
	tx.PushInput(output)
	...
	if visor.DistributionAddressInitialBalance != 5e6 {
		log.Panic("visor.DistributionAddressInitialBalance expected to be 5e6*1e6")
	}
	...
	// seckey := "22d1db900d5ec2d592c782e59b40de4575f4038e276fc36e05c3cbe677a9cd57"
	// seckeys[0] = cipher.MustSecKeyFromHex(seckey)
	// tx.SignInputs(seckeys)

	txs := make([]cipher.Sig, 1)
	sig := "ad50d6c17a32d2d35f9b819f105e6ea7fef3a9ce412cf833d0ac326f1c0f3dbf516a98bf16cbe0abcd816975a9abdb9e7cc28fc06244be9738a249704657e32401"
