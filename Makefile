...
cover: ## Runs tests on ./src/ with HTML code coverage
	go test -cover -coverprofile=cover.out -coverpkg=github.com/samoslab/haicoin/... ./src/...
...
format: ## Formats the code. Must have goimports installed (use make install-linters).
	goimports -w -local github.com/samoslab/haicoin ./cmd
	goimports -w -local github.com/samoslab/haicoin ./src
	goimports -w -local github.com/samoslab/haicoin ./lib
